...
Компјутерски галантерија </b><font size="2">&nbsp;&nbsp;( продажба )</font></font></td>
</tr></table>
...
Продажба на квалитетни компјутерска галантерија од најпознатите светски брендови<br>
<font color="#d70c0c", size="2"><b>Intel, ASUS, AMD, Delux</b></font> и многу други.</font></td></tr></table>
...
<a href="dokumenti/kompjuteri-galanterija.pdf" target="_new"><img src="design/kopce3.jpg" border="0"></a></td></tr></table>
</td></tr></table>
...
sql1= "select id from Galanterija"
...
while not obj1.eof  
	dim strpom1
		  detSQL="select * from Galanterija  WHERE  id="&obj1("id")&""
...
<font color="#646a72"> - со пресметано ДДВ 5%</font></font>
</td></tr></table> 
